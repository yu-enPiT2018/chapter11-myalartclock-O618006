...
class MainActivity : AppCompatActivity() , SimpleAlertDialog.OnClickListener
                                         , SimpleAlertDialog.DatePickerFragment.OnDateSelectedListener
                                         , SimpleAlertDialog.TimePickerFragment.OnTimeSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dateText.setOnClickListener{
            val dialog = SimpleAlertDialog.DatePickerFragment()
            dialog.show(supportFragmentManager, "date_dialog")
        }
        timeText.setOnClickListener{
            val dialog = SimpleAlertDialog.TimePickerFragment()
